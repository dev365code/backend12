...
![축구는 종교다 로고](https://github.com/user-attachments/assets/ab39a3c5-8ee4-4a52-8c43-c84c009c1a7c)
...
- **계정 보안** : 로그인 실패 시 계정 잠금

## 📈 성능 최적화 (Performance Optimization)

- **페이징 처리** : 대용량 데이터 효율적 로딩
- **이미지 최적화** : 압축 및 CDN 활용 고려
- **DB 쿼리 최적화** : 인덱스 활용, N+1 문제 해결

## 🧪 테스트 (Testing)

- **단위 테스트** : JUnit 기반 서비스 계층 테스트
- **통합 테스트** : 컨트롤러-서비스-DB 연동 테스트
- **브라우저 테스트** : 크로스 브라우저 호환성 확인
...
| 이름 | GitHub | 역할 |
|------|--------|------|
| 홍성훈 | [@callmehoon](https://github.com/callmehoon) | 팀장, 백엔드 개발 |
| 김지승 | [@kkj5158](https://github.com/kkj5158) | 프론트엔드 개발 |
| 이우용 | [@dev365code](https://github.com/dev365code) | 백엔드 개발 |
| 손장호 | [@son-j-h](https://github.com/son-j-h) | 데이터베이스 설계 |
| 이지현 | [@leejihyun2](https://github.com/leejihyun2) | UI/UX 디자인 |
